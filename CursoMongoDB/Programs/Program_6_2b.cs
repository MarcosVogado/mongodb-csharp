...
public static class Program_6_2b
{
    public static async Task ExecutarAsync()
    {
        ...
        string jsonRecebido = @"{
            ...
            ""Comentarios"": [
                {
                    ""XXXXXXXXX"": ""Incrível avanço para o entendimento das culturas pré-colombianas!"",
                    ""Curtidas"": 31,
